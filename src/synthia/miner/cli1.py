...
from synthia.miner.openai_module import OpenAIModule  # 假设我们有 OpenAI 模块


class ClaudeProviders(Enum):
    ANTHROPIC = "anthropic"
    OPENROUTER = "openrouter"
    OPENAI = "openai"  # 新增 OpenAI 选项
...
def provider_callback(value: str):
    value = value.lower()
    allowed_providers = ["anthropic", "openrouter", "openai"]  # 新增 openai 提供商
...
def serve(
    ...
    match provider_enumerated:
        ...
        case ClaudeProviders.OPENAI:  # 新增 OpenAI 模块选项
            module = OpenAIModule()
